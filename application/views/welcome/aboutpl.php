<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Promote Leads <small>The Future of Networking</small></h1>
            <ul class="breadcrumb">
                <li><a href="/welcome">Home</a></li>
                <li class="active bc">About</li>
            </ul>
        </div> <!-- /.col12 -->
    </div> <!-- /.row -->
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <?php
                echo "<div class='img-thumbnail'>";
                    echo "<img class='img-responsive' src='https://bms.cgisolution.com/user/profileimg/250/5'>";
                echo "</div> <!-- /.img-thumbnail -->";
            ?>
        ...
        <div class="col-sm-4">
            <?php
                echo "<div class='img-thumbnail'>";
                    echo "<img class='img-responsive' src='https://bms.cgisolution.com/user/profileimg/250/2'>";
                echo "</div> <!-- /.img-thumbnail -->";
            ?>
        ...
        <div class="col-sm-4">
            <?php
                echo "<div class='img-thumbnail'>";
                    echo "<img class='img-responsive' src='https://bms.cgisolution.com/user/profileimg/250/1'>";
                echo "</div>";
            ?>
...
<!--  -->
<!--         <div class="col-md-2 col-sm-4 col-xs-6"> -->
<!--         <img class="img-responsive img-customer" src="http://placehold.it/500x300x300"> -->
<!--         </div> -->
<!--  -->
<!--         <div class="col-md-2 col-sm-4 col-xs-6"> -->
<!--         <img class="img-responsive img-customer" src="http://placehold.it/500x300"> -->

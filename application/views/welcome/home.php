        ...
        <div class="carousel-inner">
          <div class="item active">
            ...
            <div class="carousel-caption">
              <h1>Promote Leads Homepage Slideshow (can hold as many as we want)</h1>
            </div>
          </div>
          <div class="item">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4">
            ...
            <ul>
                <li>If you are interested in having a Chapter in your area or being a officer forr a Chapter, please contact George Burroughs at 702-756-8378 or georgewburroughs@yahoo.com for more information </li>
                ...
                <li>Announcing the newest Chapter of Promote Leads the Henderson   Nevada Group. We will meet on Monday in Henderson NV </li>
                <li>Welcome to our new members we are excited to team with you to help your businesses grow to the next level.</li>
            </ul>
          </div>
          <div class="col-lg-4 col-md-4">
            <!-- <h3><i class="fa fa-pencil"></i> Ready to Style &amp; Edit</h3> -->
            <iframe width="375" height="200" src="//www.youtube.com/embed/2SL0-eQJHr0" frameborder="0" allowfullscreen></iframe>

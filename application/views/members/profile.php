<div class='row'>
    <div class='col-sm-3'>
        <div class='headshot'>
            <?php
                echo "<img class='img-thumbnail img-responsive' src='https://bms.cgisolution.com/user/profileimg/250/{$user->id}'>";
            ?>
        </div> <!-- /.headshot -->
    </div> <!-- /.col-md-3 -->
    <div class='col-sm-3 profileInfo'>
        <?php
    ...
    <div class='col-sm-6 profile-video pull-right'>
                            ...
                            echo <<< EOS
                                <div class='ytContainer'>
                                    <div class='yt-body'>
                                        ...
                                        <iframe class='visible-md img-thumbnail' width="202" height="102" src="//www.youtube.com/embed/{$ytid}" frameborder="0" allowfullscreen></iframe>
                                        <iframe class='visible-sm img-thumbnail' width="152" height="42" src="//www.youtube.com/embed/{$ytid}" frameborder="0" allowfullscreen></iframe>
                                    </div>
                                </div>
EOS;
                            if($rcnt == 4)

<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/welcome"><strong>Promote Leads</strong></a>
    </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="divider"></li>
            <li><a href="/chapters/profile/7">Henderson</a></li>
            <!-- <li class="divider"></li> -->
       ...
       <!--    </ul> -->
       <!--  </li> -->
        <li><a href="http://promoteleads.cgisolution.com/intranet/login"><strong>Members Area</strong></a></li>
      </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container -->
</nav>
